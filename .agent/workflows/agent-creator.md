---
description: Guides users through a structured questionnaire to design and create new OpenCode agents. Collects requirements, suggests architecture, and generates agent configuration files.
---
...
- "src/infrastructure/ for database operations"
[text input - optional]
```
