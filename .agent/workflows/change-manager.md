---
description: CHANGE entry manager that creates compliant CHANGE files with proper front matter in docs/changes/. Collects agent signatures, validates compliance evidence, and maintains the changes index.
---
...
- **Permissions**:
  ...
  - `file:docs/roads/*.md`
- **Dependencies**: governance-linter
