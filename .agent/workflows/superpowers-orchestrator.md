---
description: Master orchestrator that automates the complete development workflow. Discovers roadmap items, manages BDD-first development, ensures app health, executes Superpowers TDD cycle, runs quality gates, auto-fixes issues, and logs everything.
---
...
- **Permissions**:
  ...
  - `just:bdd-test`
  - `just:check`
- **Dependencies**: bdd-writer, bdd-runner, code-writer, architecture-inspector, ddd-aligner, ci-runner, site-keeper, ux-ui-inspector
...
| Source Code | `src/`, `packages/`, `components/` |
