---
description: BDD Test Execution Specialist. Runs BDD tests efficiently, reports results, coordinates parallel execution, identifies failing scenarios, categorizes failures.
---
...
- **Permissions**:
  - `just:bdd*`
  - `file:stack-tests/**`
- **Dependencies**: site-keeper, code-writer, bdd-writer, ci-runner
...
2. API server responding: Check console output
3. Database state: May need to reset database
