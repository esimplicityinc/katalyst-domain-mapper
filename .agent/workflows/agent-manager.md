---
description: Top-level orchestrator for managing OpenCode agents and their skills. Provides three modes: create new agents via questionnaire, edit existing agents, and analyze session files for improvement opportunities.
---
...
- **Tools**: read, write, edit, bash, question, task
- **Permissions**:
  ...
  - `just: *`
  - `git: *`
- **Dependencies**: agent-creator, agent-editor, agent-analyzer
