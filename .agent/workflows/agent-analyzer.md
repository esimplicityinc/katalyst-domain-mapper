---
description: Analyzes OpenCode session files for specific agents to identify patterns, inefficiencies, and improvement opportunities. Reviews action history, response quality, and tool usage to suggest prompt refinements.
---
