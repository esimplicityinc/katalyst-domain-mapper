---
description: Helps users edit and improve existing OpenCode agents. Compares agent behavior against documentation, identifies gaps, and suggests improvements. Can modify agent prompts and configurations.
---
