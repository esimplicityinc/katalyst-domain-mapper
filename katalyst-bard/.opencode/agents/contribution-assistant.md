...
**Always use the `API_BASE` value from the context preamble.** It is auto-detected (dev mode: `http://localhost:3001`, prod: `http://localhost:8090`).

```bash
# Set API_BASE from the context preamble (auto-detected: dev=3001, prod=8090)
