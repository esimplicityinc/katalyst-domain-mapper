...
// TODO: ContextMapDiagram skipped for now (D3 dependency)
...
export function ContextMapView({ model, onModelUpdated }: ContextMapViewProps) {
  ...
  const handleOpenChat = (ctx: BoundedContext) => {
    ...
    //   },
    // });
    console.log("TODO: open chat for context", ctx.title);
  };
  ...
  return (
    <div className="p-6">
      ...
      {/* List view (always shown — diagram view removed) */}
      <>
                  ...
                  <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <SubdomainBadge subdomainType={ctx.subdomainType ?? null} />
                      </div>
