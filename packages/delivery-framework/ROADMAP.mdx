...
> **Total Items**: 27 | **In Progress**: 0 | **Proposed**: 16 | **Complete**: 11
...
| 3 — API, Scanner, Viz & Domain Tooling | ROAD-005, 006, 008, 009, 015, 016..023, 025, 027 | ~110 | ~20 | ~9,300 |
| 4 — Advanced External Integrations | ROAD-010, 011, 012, 013, 014, 026 | ~40 | ~7 | ~4,800 |
| **Total** | **27** | **~263** | **~51** | **~17,700** |
