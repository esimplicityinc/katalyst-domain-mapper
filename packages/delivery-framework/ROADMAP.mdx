...
> **Total Items**: 23 | **In Progress**: 2 | **Proposed**: 21 | **Complete**: 0
...
─────────        ──────────       ──────────       ──────────────────────────────────────────────       ──────────
         ...
         │       └──────────┘      │
┌────────┐│                        │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌─────────────┐
│ROAD-001│┤                        ├─►│ ROAD-004 │─►│ ROAD-005 │─►│ ROAD-009 │─►│  ROAD-020   │
│Import  ││  ┌──────────┐          │  │ Parsers  │  │ API      │  │ Web Viz  │  │  Subdomain  │
...
└────────┘│  │ DDD      │             └──────────┘─┐      │                     └──────┬──────┘
          ...
          │  ┌──────────┐                  │       ├►ROAD-015 SSE         ▼            ▼          ▼
          └─►│ ROAD-007 │                  │       │                ┌──────────┐ ┌──────────┐ ┌──────────┐
             │ BDD      │                  │       │                │ ROAD-016 │ │ ROAD-017 │ │ ROAD-021 │
             └──────────┘                  │       │                │ Ctx Map  │ │ Agg Tree │ │ MD Export│
                                           │       │                └────┬─────┘ └────┬─────┘ └────┬─────┘
                                           │       │                     │            │            │
                                           │       │                ┌────┴─────┐ ┌───┴──────┐     │
                                           │       │                │ ROAD-018 │ │ ROAD-019 │     │
                                           ...
                                           │       │
                                           │       │   ┌──────────┐                        ┌──────────┐
                                           │       │   │ ROAD-023 │  Onboarding            │ ROAD-010 │
                                           │       │   │ How It   │  (standalone)           │ Jira     │
                                           │       │   │ Works    │                         └──────────┘
                                           │       │   └──────────┘                        ┌──────────┐
                                           │       │                                       │ ROAD-011 │
                                           │       │                                       │Confluence│
