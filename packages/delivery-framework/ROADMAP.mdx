...
> **Total Items**: 28 | **In Progress**: 0 | **Proposed**: 17 | **Complete**: 11
...
| 3 — API, Scanner, Viz & Domain Tooling | ROAD-005, 006, 008, 009, 015, 016..023, 025, 027, 028 | ~115 | ~22 | ~9,600 |
| 4 — Advanced External Integrations | ROAD-010, 011, 012, 013, 014, 026 | ~40 | ~7 | ~4,800 |
| **Total** | **28** | **~268** | **~53** | **~18,000** |
