...
category: Technical
status: deprecated
deprecated_reason: "Reclassified as ADR-023. This described an architectural decision, not a user-facing capability."
...
> **DEPRECATED**: This capability has been reclassified as [ADR-023](../adr/ADR-023.md). Hexagonal architecture is an architectural decision, not a user-facing system capability. All references should point to ADR-023.
