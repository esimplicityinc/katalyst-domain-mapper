...
- **UT-001** (Engineering Team Lead) — Views interactive visualizations to understand system architecture, communicate to stakeholders
- **UT-004** (Documentation Author) — Uses visualizations to validate domain model completeness
- **UT-005** (Framework Adopter) — Benefits from rich out-of-the-box visualization when adopting the framework
