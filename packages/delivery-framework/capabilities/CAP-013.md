...
- **UT-001** (Engineering Team Lead) — Adds new systems/subsystems as teams grow
- **UT-002** (Platform Engineer) — Manages environments and capability mappings
- **UT-005** (Framework Adopter) — Extends taxonomy to match organizational structure
- **UT-006** (API Consumer) — Integrates taxonomy data into external tools
