...
- **UT-002** (Platform Engineer) — Manages taxonomy entities via REST API, builds automation scripts for bulk taxonomy updates
- **UT-005** (Framework Adopter) — Uses the file adapter for GitOps YAML workflows, version-controlling taxonomy changes alongside code
