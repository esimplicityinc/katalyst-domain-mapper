...
- **UT-001** (Engineering Team Lead) — Asks targeted questions about dimension scores and receives coaching on how to improve team practices
- **UT-006** (Non-Technical Stakeholder) — Asks about improvement priorities in plain language and receives jargon-free explanations
- **UT-002** (Platform Engineer) — Performs technical deep-dives on specific findings (e.g., CI pipeline optimization, test coverage strategies)
