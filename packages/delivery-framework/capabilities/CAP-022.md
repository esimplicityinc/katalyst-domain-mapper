...
- **UT-001** (Engineering Team Lead) — Doesn't lose context when refreshing the page or returning to the app after a meeting — their selected model and project are automatically restored
- **UT-006** (Non-Technical Stakeholder) — Can bookmark and share direct links to specific views, ensuring consistent navigation to the content they care about
