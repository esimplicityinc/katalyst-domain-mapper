...
> **Note (v0.2.0):** As of @foe/schemas v0.2.0, the `ddd/` and `governance/` modules were consolidated into a unified `taxonomy/` module. File paths and import statements below referencing `src/ddd/` reflect the original implementation at time of writing.
