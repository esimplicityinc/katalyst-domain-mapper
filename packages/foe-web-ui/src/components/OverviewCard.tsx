...
const maturityColors: Record<string, string> = {
  ...
  emerging: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-200',
  practicing: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200',
  optimized: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200',
};
...
export function OverviewCard({ report }: OverviewCardProps) {
  ...
  const maturityClass = maturityColors[maturityLevel.toLowerCase()] || maturityColors.hypothesized;
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span>{repository.monorepo ? 'Monorepo' : 'Single Repository'}</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col items-center lg:items-end gap-4">
          ...
          <div className="text-center lg:text-right">
            ...
            <span className={`inline-flex px-4 py-2 text-sm font-bold rounded-lg uppercase ${maturityClass}`}>
              {maturityLevel}
            </span>
          </div>
        </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div>
            <span className="font-medium text-gray-700 dark:text-gray-300">Agents Used:</span>
          ...
          {methodology.filesAnalyzed && (
            <div>
              <span className="font-medium text-gray-700 dark:text-gray-300">Files Analyzed:</span>
              <span className="ml-2 text-gray-600 dark:text-gray-400">
                {methodology.filesAnalyzed}
              </span>
            </div>
