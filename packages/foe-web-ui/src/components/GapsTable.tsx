    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      ...
      <div className="space-y-2">
        {sortedGaps.map((gap, idx) => {
          ...
          const impact = gap.score < 30 ? 'high' : gap.score < 50 ? 'medium' : 'low';
                ...
                <div className="flex items-center gap-4 flex-1 text-left">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded uppercase font-medium ${impactColors[impact]}`}>
                        {impact} priority
                      </span>
                    </div>
                  ...
                  <div className="space-y-3 mt-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 capitalize">
                        {impact} - Improving this area will significantly enhance the {gap.area.toLowerCase()} dimension.
                      </p>
                    </div>
                    ...
                    <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        💡 Review related Field Guide methods for implementation guidance
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            <div className={`inline-flex px-3 py-1 rounded text-sm font-medium ${impactColors.high}`}>
              High Priority
            </div>
          ...
          <div>
            <div className={`inline-flex px-3 py-1 rounded text-sm font-medium ${impactColors.medium}`}>
              Medium Priority
            </div>
            <div className="text-2xl font-bold text-gray-900 dark:text-white mt-2">
          ...
          <div>
            <div className={`inline-flex px-3 py-1 rounded text-sm font-medium ${impactColors.low}`}>
              Low Priority
            </div>
            <div className="text-2xl font-bold text-gray-900 dark:text-white mt-2">
