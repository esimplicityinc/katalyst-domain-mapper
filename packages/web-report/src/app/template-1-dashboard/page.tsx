...
import { ChevronDown, ChevronUp, ArrowLeft, AlertTriangle, CheckCircle, TrendingUp } from 'lucide-react';
            ...
            {dimension.subscores.map((subscore, index) => (
              <div key={index} className="bg-white rounded-lg p-4 border border-gray-200">
                ...
                {subscore.gaps.length > 0 && (
                  <div className="mb-3">
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Gaps</p>
                    <ul className="text-sm text-gray-600 space-y-1">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${impactColors[recommendation.impact]}`}>
...
export default function DashboardTemplate() {
  ...
  const displayedCritical = showAllCritical ? criticalFailures : criticalFailures.slice(0, 3);
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">FOE Scan Report - Dashboard View</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              />
              <div className="mt-4">
                <MaturityBadge level={typedReport.maturityLevel} score={typedReport.overallScore} />
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed">{typedReport.executiveSummary}</p>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-gray-900">Critical Failures</h2>
            ...
            {criticalFailures.length > 3 && (
              ...
              >
                {showAllCritical ? 'Show Less' : `Show All (${criticalFailures.length})`}
              </button>
            )}
          </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900">Dimension Details</h2>
          </div>
          <div className="space-y-4">
            {dimensions.map(({ key, data }) => (
              <DimensionCard
        ...
        <section className="bg-gray-50 rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">{typedReport.methodology.filesAnalyzed}</p>
              <p className="text-sm text-gray-500">Files Analyzed</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">{typedReport.methodology.testFilesAnalyzed}</p>
              <p className="text-sm text-gray-500">Test Files</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">{typedReport.methodology.adrsAnalyzed}</p>
              <p className="text-sm text-gray-500">ADRs Analyzed</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">{typedReport.assessmentMode}</p>
              <p className="text-sm text-gray-500">Assessment Mode</p>
            </div>
          </div>
          <div className="border-t border-gray-200 pt-4">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Confidence Notes</p>
            <ul className="text-sm text-gray-600 space-y-1">
