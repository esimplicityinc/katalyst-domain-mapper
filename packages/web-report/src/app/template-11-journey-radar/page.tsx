...
export default function Template11JourneyRadar() {
  ...
  const [hoveredCategory, setHoveredCategory] = useState<PPTCategory | null>(
    null,
  );
  ...
  const timelineData = useMemo(
    () => getTimelineWithPPT(report.overallScore),
    [],
  );
  ...
  const currentMilestoneIndex = timelineData.findIndex(
    (m) =>
      report.overallScore >= m.minScore && report.overallScore <= m.maxScore,
  );
                ...
                {radarView === "foe" ? (
                  ...
                  <RadarChart data={matrixRadarData}>
                    ...
                    <Tooltip
                      ...
                      ) => [`${value}%`, props.payload?.fullLabel || "Score"]}
                    />
                  </RadarChart>
                )}
              </ResponsiveContainer>
            ...
            <table className="w-full min-w-[500px]">
              ...
              <tbody>
                ...
                <tr className="border-t border-slate-700 bg-slate-800/30">
                  <td className="p-3 text-sm font-medium text-slate-400">
                    Total
                  </td>
                  {categories.map((cat) => {
                    const total = matrix.totals[cat];
                          ...
                          <div className="h-1.5 bg-slate-700 rounded-full overflow-hidden mt-1">
                            <div
                              ...
                              style={{
                                ...
                                backgroundColor:
                                  pptColors[selectedCell.category].primary,
                              }}
                            />
                          </div>
                        </div>
              ...
              <div className="absolute top-1/2 left-0 right-0 -translate-y-1/2 pointer-events-none">
                ...
                <div
                  ...
                  style={{
                    left: "50%",
                    backgroundColor:
                      report.overallScore >= 50 ? "#f59e0b" : "#475569",
                  }}
                  aria-hidden="true"
                />
                ...
                <div
                  ...
                  style={{
                    left: "75%",
                    backgroundColor:
                      report.overallScore >= 75 ? "#10b981" : "#475569",
                  }}
                  aria-hidden="true"
                />
                {/* End marker (100) */}
                <div
                  ...
                  style={{
                    left: "100%",
                    backgroundColor:
                      report.overallScore >= 100 ? "#10b981" : "#475569",
                  }}
                  aria-hidden="true"
                />
              </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Users
                          ...
                          style={{ color: pptColors.people.primary }}
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <Workflow
                          className="w-3 h-3 flex-shrink-0"
                          style={{ color: pptColors.process.primary }}
                        />
                        <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                          <div
                            className="h-full rounded-full transition-all duration-500 motion-reduce:transition-none"
                      ...
                      <div className="flex items-center gap-2">
                        <Cpu
                          className="w-3 h-3 flex-shrink-0"
                          style={{ color: pptColors.tech.primary }}
                        />
                        <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                          <div
                            className="h-full rounded-full transition-all duration-500 motion-reduce:transition-none"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-slate-300 mt-1">
                  {timelineData[currentMilestoneIndex + 1].minScore -
                    report.overallScore}{" "}
                  more points needed
                </div>
              </div>
