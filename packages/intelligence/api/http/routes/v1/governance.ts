  ...
  return (
    new Elysia({ prefix: "/governance" })
      ...
      .post(
        ...
        {
          detail: {
            summary: "Ingest a governance index snapshot",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        {
          detail: {
            summary: "Get the latest governance snapshot",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        {
          detail: {
            summary: "List all governance snapshots",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            summary: "Get a governance snapshot by ID",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            summary: "List road items with optional status filter",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        {
          detail: {
            summary: "Get capability coverage report",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            summary: "Get governance health trends",
            tags: ["Governance"],
          },
        },
      )
      ...
      .get(
        ...
        {
          detail: {
            summary: "Get cross-reference integrity report",
            tags: ["Governance"],
          },
        },
      )
      ...
      .delete(
        ...
        async () => {
          ...
          return {
            message: `Deleted ${deleted} governance snapshots`,
            count: deleted,
          };
        },
        {
          detail: {
            summary: "Delete all governance snapshots",
            tags: ["Governance"],
          },
        },
      )
      ...
      .delete(
        ...
        },
        {
          params: t.Object({ id: t.String() }),
          detail: {
            summary: "Delete a governance snapshot",
            tags: ["Governance"],
          },
        },
      )
      ...
      .post(
        ...
        {
          detail: {
            summary: "Validate a road item state transition",
            tags: ["Governance"],
          },
        },
      )
